...
struct yamaha_mc1n2_audio_params_init i9152_params_init = {
	.ae_info = {
		.bOnOff = 0x00,
		.abBex = { 0x00 },
		.abWide = { 0x00 },
...
struct yamaha_mc1n2_audio_params_route i9152_params_routes[] = {
	{
...
struct yamaha_mc1n2_audio_device_ops i9152_ops = {
	.hw_node = "/dev/snd/hwC0D0",
	.hw_fd = -1,
	.params = {
		.init = &i9152_params_init,
		.routes = &i9152_params_routes,
		.routes_count = sizeof(i9152_params_routes) /
			sizeof(struct yamaha_mc1n2_audio_params_route),
	},
};

struct yamaha_mc1n2_audio_pdata i9152_pdata = {
	.name = "i9152",
	.ops = &i9152_ops,
};
